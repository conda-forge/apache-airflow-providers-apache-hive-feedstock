About apache-airflow-providers-apache-hive-feedstock
====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-apache-hive-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-apache-hive-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-apache-hive
# for installing globally
pixi global install apache-airflow-providers-apache-hive
```
...
It is possible to list all of the versions of `apache-airflow-providers-apache-hive` available on your platform:
...
```
pixi search apache-airflow-providers-apache-hive --channel conda-forge
```
